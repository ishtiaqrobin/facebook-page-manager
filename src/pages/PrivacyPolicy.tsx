    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6 text-gray-700">
        <section>
          ...
          <p>
            This Privacy Policy describes how Facebook Auto Poster ("we", "our",
            or "us") handles your personal information when you use our
            application. This is a personal project designed for individual use.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            As this is a personal project, you have full control over your data.
            You can:
          </p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          ...
          <p>
            For any privacy-related questions or concerns, please contact the
            developer directly.
          </p>
        </section>
